...
function myWebGuard() {
    ...
    const storages = {
        sessionStorage: {
            ...
            getCodeOriginList: function () {
                ...
                return json == null ? [utils.getTopOrigin(),] : builtins.parseJson(json);
            },
    ...
    const monitor = {
        method: function (object, methodName, policy) {
            while (!builtins.hasOwnProperty.call(object, methodName) && object.__proto__)
        ...
        property: function (prototype, propertyName, policies) {
            while (!builtins.hasOwnProperty.call(prototype, propertyName) && prototype.__proto__)
                prototype = prototype.__proto__;
            if (prototype === null) {
                throw new Error('Failed to find function for alias ' + propertyName);
            }
            const descriptor = builtins.getOwnPropertyDescriptor(prototype, propertyName);
        ...
        getCodeOrigin: function () {
            ...
            if (urls != null) {
                ...
                storages.sessionStorage.addCodeOrigin(origin);
                return origin;
            }
            return undefined;
        },
    ...
    monitor.property(HTMLImageElement.prototype, 'src', {
        set: function (obj, args, proceed) {
            ...
            utils.printVerbose('[HTMLImageElement.prototype.src]', 'Blocked code execution from', codeOrigin);
        }
    });
    monitor.property(HTMLScriptElement.prototype, 'src', {
        set: function (obj, args, proceed) {
            ...
            utils.printVerbose('[HTMLScriptElement.prototype.src]', 'Blocked code execution from', codeOrigin);
        }
    });
    monitor.property(Element.prototype, 'innerHTML', {
        set: function (obj, args, proceed) {
            ...
            utils.printVerbose('[Element.prototype.innerHTML]', 'Blocked code execution from', codeOrigin);
        }
    });
    monitor.method(Element.prototype, 'setAttribute', function (obj, args, proceed) {
        ...
        utils.printVerbose('[Element.prototype.setAttribute]', 'Blocked code execution from', codeOrigin);
    });
    monitor.method(Element.prototype, 'appendChild', function (obj, args, proceed) {
        const codeOrigin = monitor.getCodeOrigin();
        if (!monitor.isOriginBlocked(codeOrigin))
            return proceed();

        utils.printVerbose('[Element.prototype.appendChild]', 'Blocked code execution from', codeOrigin);
    });
    monitor.method(document, "createElement", function (obj, args, proceed) {
        ...
        utils.printVerbose('[document.createElement]', 'Blocked code execution from', codeOrigin);
    });
    monitor.method(XMLHttpRequest.prototype, 'open', function (obj, args, proceed) {
        let block = false;
        try {
            const val = args[1].toString();
            if (utils.isCrossOrigin(val)) {
        ...
        utils.printVerbose('[XMLHttpRequest.prototype.open]', 'Blocked code execution from', codeOrigin);
    });
};